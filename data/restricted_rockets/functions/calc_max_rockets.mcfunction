...
execute if score __ __override_max_rockets matches 0 run \
    scoreboard players operation @s __temp2 = __ __max_rockets

# client overridable
execute if score __ __override_max_rockets matches 1 run function __:calc_max_rockets/overridable
{
